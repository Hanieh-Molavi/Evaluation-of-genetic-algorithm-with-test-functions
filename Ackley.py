...
for i in range(0,20):
    ...
    ackley_model=ga(function=ackley,dimension=2,variable_type='float',variable_boundaries=varbound)
            
            
    ackley_model.run()
    sol.append(ackley_model.output_dict)
